...
class TownshipDropDown extends StatelessWidget {

    const TownshipDropDown({super.key,required this.controller});
...
final CreateSaduditharController controller;
  ...
  Widget build(BuildContext context) {
    ...
    return   Obx((){
              final townshipsController = DropdownController<Township>.single(
    items: List.generate(
      controller.selectedCity.townships.length,
      (index) => DropdownItem(value:controller.selectedCity.townships[index]),
    ),
  );
      return   SimpleDropdown<Township>.list(
            controller:townshipsController,
           ...
           boxShadow: [
            ...
            builder: (_) =>Container(
                ...
                child: Row(
                  ...
                  children: [
                    Text(
                    controller.selectedTownship.name,
            ...
            itemBuilder: (_, item) => GestureDetector(
              onTap: () {
                townshipsController.select(item.value, dismiss: true);
                controller.setTownship(item.value);
              },
              child: Container(
