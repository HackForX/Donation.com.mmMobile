...
class EditItemDropdown extends StatelessWidget {

    const EditItemDropdown({super.key,required this.controller});
 
final EditNatebanzayController controller;
  @override
  Widget build(BuildContext context) {
    ...
    return   Obx((){
              final itemsController = DropdownController<Item>.single(
    items: List.generate(
      controller.items.length,
      (index) => DropdownItem(value: controller.items[index]),
    ),
  );
