...
class ForgotPinCodeView extends StatefulWidget {
  ...
  @override
  State<ForgotPinCodeView> createState() => _ForgotPinCodeViewState();
}

class _ForgotPinCodeViewState extends State<ForgotPinCodeView> {
                ...
                child: ButtonTheme(
                  ...
                  child: TextButton(
                    onPressed: () {
                      ...
                      _authController.verifyForgotPin(widget.token,widget.phoneNumber ?? '',
                          _authController.requestId ?? '', _authController.pin);
                    },
                    child: Center(
                      child: Text(
                        "VERIFY".toUpperCase(),
